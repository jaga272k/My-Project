...
session_start();
	...
	if(isset($_POST['reset'])){
		 ...
		 $a_no=$_POST['aadhar_no'];
		  ...
		  if($a_no == $u_id){
			 $result3=mysqli_query($conn,"UPDATE vehicl SET address = '$new_address'  WHERE reg_no = '$register' AND aadhar_no = '$a_no'");
			 if($result3){
...
<div class="mobile">
    ...
    <label><textarea name="address" required="" class="textarea-field" placeholder="enter new address" ></textarea></label><br>
	
	<label><input type="text" class="input-field" required="" placeholder="enter temporary register no" name="register" value="" /></label>
